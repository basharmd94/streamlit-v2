...
class Analytics:
    ...
    def _load(self, table_name, zid=None, project=None, filters=None):
        ...
        query_map = {
            ...
            "new_order_detail":     queries.get_new_order_detail,
            ...
            "bulk_area_salesman_orders": queries.get_bulk_area_salesman_orders,
            "bulk_order_date":           queries.get_bulk_order_date_customers,
            "bulk_sales_lines":          queries.get_bulk_sales_lines,
            "bulk_returns_lines":        queries.get_bulk_returns_lines,
            "bulk_collection_lines":     queries.get_bulk_collection_lines,
            "bulk_last_sale_dates":      queries.get_bulk_last_sale_dates,
            ...
            "hmbr_catalog_lookup":      queries.get_hmbr_catalog_lookup,
